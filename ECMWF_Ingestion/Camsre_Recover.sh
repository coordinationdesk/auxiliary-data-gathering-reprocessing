...
while [[ $STOP_DATE < $TO_DATE ]] ; do 
    ...
    /CAMSRE_Ingestion.sh $WORK_DIR/CAMSRE_Recover_2023_$START_DATE 2>&1 | tee /ecmwf/camsre_recover_2023_from_$START_DATE.out
    echo "Execution" 2>&1 | tee /ecmwf/camsre_recover_2023_from_$DATE1.out
