...
from baseline_s1_l0_client import S1_L0_NamesLoader
...
def get_command_arguments():
    ...
    parser.add_argument("-fd", "--fromdate",
                        ...
                        required=False)
    parser.add_argument("-icid", "--geticid",
        ...
        if l0_list_file is not None:
            with open(l0_list_file, "r") as fid:
                for line in fid.readlines():
                    ...
                    l0_loader.add_l0_name_validities(l0_validities)
        else:
            #if args.fromdate:
            ...
            if args.geticid and mission == 'S1':
                lta_retriever = L0IcidExtractor(mission, args.workingdir,
                                                args.ltaurl, args.ltauser, args.ltapassword,
                                                num_days)
            else:
                lta_retriever = LtaL0Retriever(mission,
                                               args.ltaurl, args.ltauser, args.ltapassword,
                                               num_days)
